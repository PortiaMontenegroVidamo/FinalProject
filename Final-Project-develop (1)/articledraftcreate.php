<?php
        if (isset($_POST['submit'])){
            ...
            $connection = mysqli_connect("localhost", "root", "", "pmdb");
                ...
                //$query = "INSERT INTO pmdb.articledraft (title,author,content,image,category,status) VALUES ('$title', '$author', '$content', '$image', '$category', '$status')";
                $query = "INSERT INTO pmdb.articledraft (title,author) VALUES ('$title', '$author')";
...
<body>
<form method="post" action="articledraft.php">
